...
function Login() {
    ...
    const login = (event) => {
        event.preventDefault(); // this line helps stops refreshing when signed in
    ...
    return (
        <div className="login">
            ...
            <div className="login__container">
                ...
                <p>
                    By continuing,
                    you agree to Amazon's Conditions of Use and Privacy Notice.
                </p>
